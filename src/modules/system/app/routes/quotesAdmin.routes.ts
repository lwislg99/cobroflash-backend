...
router.get('/:id/pdf', async (req, res) => {
  try {
    ...
    const pdf = await generateQuotePdf({
      ...
      // SCRUM-593 (DOC-03): la TERCERA generación del mismo documento. Las tres tienen que
      // pintar lo mismo: un PDF que cambia según por qué puerta se pidió no es el documento.
