# AGENTS.md — Constitución de Codex para YaQu
...
10. **`AGENTS.md` y `.Codex/*` son derivados del master** (regla 35). Prohibido instalar
...
- `src/integrations/` whatsapp, stripe, mercadopago, Codex, mailer (Resend en prod)
