...
// ⚠️ `CAJA_PUERTO` SIGUE MANDANDO: quien quiera fijarlo, lo fija — y si ese puerto está ocupado, el
...
let PUERTO = Number(process.env.CAJA_PUERTO || 0);
...
PUERTO = await levantarServidor(s, PUERTO, '127.0.0.1');
