...
test('SCRUM-120: PATCH /admin/jobs/:id — gate por campo (técnico: operativo ✅, fiscal/dinero ❌ fail-closed)', { skip: !ENABLED && 'sin QA_DB_TEST=1 · npm run test:staging:gated' }, async (t) => {
