...
//
// 🔴 SEXTA VEZ, y las DOS entradas de arriba se conservan enteras: son `margenCatalogo.js` y
// `switchTipoArticulo.js`, dos scripts y dos hechos distintos del mío. Borrar una sería perder
// POR QUÉ entró un script.
//
// SCRUM-655 (2-sep-2026) · 68 → 69: entra `quoteApartados.js` — apartados con título,
// numeración derivada (1.01, 1.02…) y la descripción larga como ESTRUCTURA, un elemento por
// renglón. Va junto a los demás módulos puros de presupuesto.
//
// ⚠️ Mi entrada decía «66 → 67» cuando la escribí, antes de mezclar, y las dos cifras eran
// falsas al mezclar: main había metido dos scripts por medio. La flecha es tan DERIVADA como el
// número, así que se recalcula igual — ni se elige un lado, ni se suma, ni se hereda de ningún
// informe. Contado sobre el índice ya mezclado:
