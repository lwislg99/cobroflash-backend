...
//
// Es el principio 1 de docs/QA/SUITE_REGRESION.md, sección «Escribir verificaciones»
// («pruébalo en rojo, modo por modo»), aplicado al arreglo y no solo al test original: **un arreglo
