...
const CENSO = Object.freeze({
  ...
  'jobNuevoModal.js': 1,
  // 🔴 3-sep-2026 · SALE DEL CENSO: el fundador aprobo los CINCO textos del selector de
  // QUIEN EJECUTA, sin un solo cambio. Esa marca pintaba CINCO y se apago de golpe, que es justo
  // lo que la constante unica existia para permitir. Entrada BORRADA, no puesta a 0 (SCRUM-424 /
  // SCRUM-405): `censoActual()` solo lista ficheros CON marcadores. Y salir del censo NO saca de
  // la vigilancia - lo fija R4b.
