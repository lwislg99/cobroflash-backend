...
// `merchantId: { notIn: ids }` durante los 21 `deleteMany` siguientes: decidía con una foto y
...
test('SCRUM-272 · tabla y columna salen del DMMF, no se derivan a mano', async () => {
  // Medido en el schema real: de los 21 modelos, **19 llevan `@map("merchant_id")` y 2 NO** —
