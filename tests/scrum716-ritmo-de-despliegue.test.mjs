...
export const MUTACIONES_QUE_ME_TUMBAN = [
  ...
  },
  {
    ...
    // 🔴 SCRUM-824b partió el filtro en dos líneas (longitud de reloj, no «todo dígitos») sin
    // tocar esta ancla, que seguía citando la forma de antes: CIEGA desde entonces.
    fichero: 'scripts/_ritmo-de-despliegue.mjs',
