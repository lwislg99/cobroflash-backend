...
export const MUTACIONES_QUE_ME_TUMBAN = [
  ...
  },
  {
    ...
    // ⚠️ SCRUM-824b partió la condición en DOS `if` (formato vs. longitud de reloj); se apagan
    // los DOS, que es el mismo apagado total que antes hacía una sola línea con `false`.
    fichero: 'scripts/_ritmo-de-despliegue.mjs',
