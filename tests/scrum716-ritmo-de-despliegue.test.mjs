...
export const MUTACIONES_QUE_ME_TUMBAN = [
  ...
  },
  {
    ...
    // ⚠️ SCRUM-824b partió el `if` combinado en DOS (ES_SHA y TODO_DIGITOS+LONGITUDES_DE_RELOJ, para
    // distinguir por longitud y no por «todo dígitos»): el ancla se actualiza a las dos líneas.
    fichero: 'scripts/_ritmo-de-despliegue.mjs',
