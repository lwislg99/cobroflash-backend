...
export const MUTACIONES_QUE_ME_TUMBAN = [
  ...
  },
  {
    ...
    // ⚠️ SCRUM-824b partió la línea única en dos (formato, y luego longitud de reloj): el ancla
    // sigue las DOS a la vez para seguir apagando el filtro entero, no solo una mitad.
    fichero: 'scripts/_ritmo-de-despliegue.mjs',
