...
export const MUTACIONES_QUE_ME_TUMBAN = [
  ...
  },
  {
    ...
    // SCRUM-824b partió el filtro en DOS `if` (uno por forma hex, otro por longitud de reloj);
    // este ancla apuntaba a la versión anterior, de una sola línea, y se quedó caduca.
    fichero: 'scripts/_ritmo-de-despliegue.mjs',
