...
import { CreateChargeSchema } from '../utils/schemas';
import { normalizePhone, makeReference } from '../lib/utils';
...
router.post('/:id/send', async (req, res) => {
  try {
    ...
    const payload = {
        ...
        // (Opcional: dejamos estas para usos futuros, o las borras si quieres)
