  ...
  const botones = {
    ...
    btnFirmarAqui: () => mk('btnFirmarAqui', () => {
      ...
      window.openSignaturePad({
        ...
        // SCRUM-300 (C5) · LLEGA AQUÍ POR LA FUSIÓN CON C2, Y NO ES COSMÉTICO: firmar sin declarar
        // quién firma responde 400 desde C5. Cuando C2 movió el botón a esta página, esta llamada
        // se quedó sin la declaración — el botón se habría roto en cuanto entrasen las dos ramas.
        // El nombre va VACÍO y el chip lo rellena de un toque: prerrellenarlo sellaría una
        // declaración que el firmante no ha hecho.
        firmante: { sugerencia: (alb.customer && (alb.customer.name || alb.customer.legalName)) || '' },
