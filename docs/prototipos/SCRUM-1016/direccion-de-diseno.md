...
- El último commit que tocó `public/index.html` es del **20-ago-2026** — un mes antes. El héroe en
  producción sigue diciendo hoy, verificado en el código a las 16:48Z: *"Del presupuesto al cobro, sin
  salir de WhatsApp"*, con el subtítulo *"...te paga la señal antes de que empieces — con tarjeta,
  Bizum o transferencia"*.
- **Ese subtítulo es falso para cualquier profesional español desde las 14:55:34Z de hoy**:
