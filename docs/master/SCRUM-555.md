...
> ⚠️ **Lo de abajo entró como fichero aparte (`SCRUM-555-punto4.md`) y pasa a APÉNDICE.**
...
>
> El contenido **no cambia**: es el punto 4 del mismo ticket, entregado dos días después que los
> puntos 1, 2 y 3. Que fueran dos entregas es justo el motivo por el que existe la regla — dos
> entradas del mismo ticket van una detrás de otra, no en dos ficheros que se puedan pisar.
