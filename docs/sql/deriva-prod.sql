...
--
-- Columnas esperadas: 465. Tablas: 30.
...
WITH esperado (tabla, columna) AS (
  VALUES
    ...
    ('albaranes','customer_email'),
    ('albaranes','customer_legal_name'),
    ('albaranes','customer_name'),
    ('albaranes','customer_phone'),
    ('albaranes','customer_tax_id'),
    ...
    ('expenses','vat_rate'),
    ('gateway_events','attempts'),
    ('gateway_events','event_id'),
    ('gateway_events','id'),
    ('gateway_events','last_error'),
    ('gateway_events','processed_at'),
    ('gateway_events','provider'),
    ('gateway_events','received_at'),
    ('gateway_events','type'),
    ...
    ('invoices','customer_legal_name'),
    ('invoices','customer_name'),
    ('invoices','customer_phone'),
    ('invoices','customer_tax_id'),
    ('invoices','customerId'),
    ('invoices','deducts_refs'),
    ('invoices','discount_global_amount'),
    ('invoices','id'),
    ('invoices','lines'),
    ('invoices','merchant_address'),
    ('invoices','merchant_email'),
    ('invoices','merchant_legal_name'),
    ('invoices','merchant_logo_url'),
    ('invoices','merchant_name'),
    ('invoices','merchant_phone'),
    ('invoices','merchant_tax_id'),
    ('invoices','merchantId'),
    ('invoices','number'),
    ('invoices','paid_at'),
    ('invoices','paid_via'),
    ...
    ('merchants','clabe'),
    ('merchants','clausulas_presupuesto'),
    ...
    ('partes_trabajo','contenido_hash'),
    ('partes_trabajo','contenido_version'),
    ('partes_trabajo','created_at'),
    ('partes_trabajo','customer_id'),
    ('partes_trabajo','desplazamientos'),
    ('partes_trabajo','entrada'),
    ('partes_trabajo','estado'),
    ('partes_trabajo','fecha'),
    ('partes_trabajo','firmado_at'),
    ('partes_trabajo','firmado_por_calidad'),
    ('partes_trabajo','firmado_por_nombre'),
    ('partes_trabajo','firmado_tecnico_at'),
    ('partes_trabajo','firmado_tecnico_nombre'),
    ('partes_trabajo','id'),
    ('partes_trabajo','job_id'),
    ('partes_trabajo','kilometros'),
    ('partes_trabajo','lineas'),
    ('partes_trabajo','merchant_id'),
    ('partes_trabajo','notas'),
    ('partes_trabajo','numero'),
    ('partes_trabajo','obra'),
    ('partes_trabajo','referencia'),
    ('partes_trabajo','salida'),
    ('partes_trabajo','signature_tecnico_url'),
    ('partes_trabajo','signature_url'),
    ('partes_trabajo','tecnicos'),
    ('partes_trabajo','tipo'),
    ('partes_trabajo','updated_at'),
    ('products','cost'),
    ('products','created_at'),
