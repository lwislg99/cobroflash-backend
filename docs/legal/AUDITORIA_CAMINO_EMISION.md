...
| 4 | Huella SHA-256 y encadenado a la anterior | **EXISTE** | `prisma/schema.prisma:903-904` (`vf_hash`, `vf_prev_hash`) — SCRUM-1107 (25-sep-2026) movió la línea: la retención de garantía de obra añadió campos por encima en el mismo modelo. La afirmación NO cambia: la huella y el encadenado siguen exactamente donde estaban |
