...
> **ORDEN303, medido en el consolidado del BOE el 25-sep-2026 (SCRUM-1096):** la orden **no está derogada**, y su art. 7.2 (el plazo que cita la §3) sigue en su redacción de 2017. Lo que se sustituyó es su **anexo I** —el impreso del 303, con las casillas—, que hoy es el anexo III de la Orden HAC/27/2026 (art. 2; https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-1761).

**Nota de método.** Las **26 citas** de la §3 (todo lo que va entre comillas angulares) se comprobaron contra los ficheros bajados: **26 de 26 aparecen literales** (salvo espacios, saltos de línea y comillas tipográficas) — 16 verificadas el 21-sep, 10 nuevas el 22-sep (SCRUM-1039). Población de texto por fuente, en caracteres: LIVA 748.965 · RIVA 445.672 · LIRPF 832.142 · RIRPF 481.395 · RFACT 106.999 · ORDEN303 48.793. El comprobador lleva **control negativo**: una cita alterada a propósito (21 → 1021 por ciento) sale como no encontrada y la original sí; código de salida 0 (22-sep-2026). **[CORREGIDO 25-sep-2026, SCRUM-1118:** del 23 al 25-sep el comprobador daba 27 de 29 y exit 1. Las dos citas del RFACT 6.1.m y 6.2.b (SCRUM-1106b) usaban "(…)" para saltarse texto legal real. **La norma estaba bien citada; lo que estaba mal era la FORMA de la cita**: cada fragmento era literal en el RFACT. Se partieron en dos citas contiguas cada una. Hoy: **31 citas extraídas del documento (30 en la §3, 1 en la §4), 31 de 31**, control negativo OK, exit 0.**]** Uso: `node docs/verificacion/comprobar-citas-contabilidad.mjs docs/producto/CONTABILIDAD.md <carpeta con LIVA.html RIVA.html LIRPF.html RIRPF.html RFACT.html ORDEN303.html>`.
